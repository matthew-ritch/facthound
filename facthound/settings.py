"""
Django settings for facthound project.
...
WSGI_APPLICATION = "facthound.wsgi.application"
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Default: 60 minutes
